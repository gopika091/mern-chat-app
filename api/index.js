...
connect('mongodb+srv://mernchat:mernchat089@cluster0.cicnco4.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0') // Replace with your Atlas string
...
app.use(cors({
    credentials: true,
    origin: process.env.MY_CHAT_APP_URL || 'http://localhost:5176'
}));
